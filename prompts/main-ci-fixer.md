...
```bash
export PATH="/root/.rbenv/versions/3.2.8/bin:/home/[your-user]/.local/bin:$PATH"
...
node /home/[your-user]/claude-code-discord-starter/workspace/scripts/discord-post.js 1494841582413938940 "🔴 **MAIN CI FIXER** · $(TZ=America/New_York date '+%Y-%m-%d %H:%M ET')
SHA: $SHA_SHORT
